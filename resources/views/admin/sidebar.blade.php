<div class="sidebar-wrapper">
    ...
    <div>
        ...
        <div class="logo-icon-wrapper">
            <a href="index.html">
                <img class="img-fluid main-logo main-white" src="/template/admin/assets-backend/images/logo/logo.png" alt="logo">
                <img class="img-fluid main-logo main-dark" src="/template/admin/assets-backend/images/logo/logo-white.png"
                    alt="logo">
            </a>
        </div>
